...
C {lab_pin.sym} 280 -30 0 0 {name=l9 sig_type=std_logic lab=vss}
...
C {lab_pin.sym} 330 -110 2 0 {name=l14 sig_type=std_logic lab=out}
C {vsource.sym} -350 80 0 0 {name=V4 value="PULSE(0 \{VIN\} \{bDUTY\} 1p 1p \{bDUTY\} \{bT\}) DC(\{VIN\})"}
C {netlist_not_shown.sym} 420 -110 0 0 {name=s1 only_toplevel=false value="
...
C {nor/nor.sym} 210 -80 0 0 {name=x1}
