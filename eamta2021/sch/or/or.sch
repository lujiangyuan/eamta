...
S {}
E {}
N 740 -450 740 -440 { lab=#net1}
N 740 -450 870 -450 { lab=#net1}
N 870 -450 870 -440 { lab=#net1}
N 800 -480 800 -450 { lab=#net1}
N 800 -560 800 -540 { lab=#net2}
...
N 970 -550 970 -410 { lab=#net1}
N 1010 -380 1010 -350 { lab=vss}
N 910 -350 1010 -350 { lab=vss}
N 1010 -410 1050 -410 { lab=vss}
N 1050 -410 1050 -350 { lab=vss}
N 1010 -350 1050 -350 { lab=vss}
N 1010 -520 1010 -440 { lab=O}
N 800 -470 970 -470 { lab=#net1}
N 1010 -470 1130 -470 { lab=O}
N 1010 -670 1010 -580 { lab=vdd}
N 840 -670 1010 -670 { lab=vdd}
N 1010 -550 1050 -550 { lab=vdd}
N 1050 -670 1050 -550 { lab=vdd}
N 1010 -670 1050 -670 { lab=vdd}
...
C {opin.sym} 1130 -470 0 0 {name=p5 lab=O
}
C {sky130_fd_pr/pfet_01v8.sym} 990 -550 0 0 {name=M5
L=0.15
W=\{WP\}
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 990 -410 0 0 {name=M6
L=0.15
W=\{WN\}
nf=1 
mult=1
