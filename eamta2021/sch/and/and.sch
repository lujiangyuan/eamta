...
S {}
E {}
N 260 -310 260 -280 { lab=#net1}
N 260 -280 420 -280 { lab=#net1}
N 420 -310 420 -280 { lab=#net1}
N 350 -160 350 -130 { lab=#net2}
N 350 -70 350 -30 { lab=vss}
N 350 -280 350 -220 { lab=#net1}
...
N 560 -330 560 -230 { lab=#net1}
N 600 -440 600 -360 { lab=vdd}
N 420 -440 600 -440 { lab=vdd}
N 600 -330 650 -330 { lab=vdd}
N 650 -390 650 -330 { lab=vdd}
N 600 -390 650 -390 { lab=vdd}
N 420 -280 560 -280 { lab=#net1}
N 600 -300 600 -260 { lab=Y}
N 600 -200 600 -20 { lab=vss}
N 400 -20 600 -20 { lab=vss}
N 600 -230 640 -230 { lab=vss}
N 640 -230 650 -230 { lab=vss}
N 650 -230 650 -180 { lab=vss}
N 600 -180 650 -180 { lab=vss}
N 600 -280 680 -280 { lab=Y}
...
C {opin.sym} 680 -280 0 0 {name=p6 lab=Y}
...
C {sky130_fd_pr/pfet_01v8.sym} 580 -330 0 0 {name=M5
L=0.15
W=\{WP\}
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 580 -230 0 0 {name=M6
L=0.15
W=\{WN\}
nf=1 
mult=1
